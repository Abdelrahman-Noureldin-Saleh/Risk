...
public class Map {
    ...
    private LinkedList<Vertex>[] unitedStates;
    private LinkedList<Vertex>[] egypt;

    public Map() {
        unitedStates = new LinkedList[51];
        egypt = new LinkedList[28];
    }
    
    private void buildStates(){
        
        Vertex[] states = new Vertex[51];
        
        for (int i = 1; i <= 50; i++)
            states[i] = new Vertex(i);
        
        unitedStates[1].add(states[2]); unitedStates[1].add(states[5]);
        
        unitedStates[2].add(states[1]); unitedStates[2].add(states[3]); unitedStates[2].add(states[4]); unitedStates[2].add(states[5]);
